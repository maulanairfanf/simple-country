...
<template>
	<div>
		<div class="grid md:grid-cols-2 grid-cols-1 gap-4 mt-10">
			<div class="shadow-md flex justify-between flex-wrap">
				<div class="flex flex-col ml-10 justify-center">
					...
					<div class="flex items-center">
						...
						>
							{{ item }}
							<span v-if="index < latLang.length - 1">, </span>
						</span>
					</div>
				</div>
				<div>
			...
			<div class="shadow-md flex flex-col justify-center min-h-32">
				<div class="ml-10">
					<div class="text-lg">
						Capital: <span class="font-bold">{{ capital }}</span>
					</div>
					<div class="text-lg">
						Region: <span class="font-bold">{{ region }}</span>
					</div>
					<div class="text-lg">
						Subregion: <span class="font-bold">{{ subregion }}</span>
					</div>
				</div>
			</div>
		</div>
